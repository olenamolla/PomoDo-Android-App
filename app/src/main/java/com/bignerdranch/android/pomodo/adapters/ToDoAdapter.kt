...
class ToDoAdapter(private val db: DatabaseHandler, private val fragmentManger: FragmentManager, private val activity: MainActivity) :
    ...
    fun editItem(position: Int) {
        ...
        fragment.show(fragmentManger, AddNewTask.TAG)
    }
